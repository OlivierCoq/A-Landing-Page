	...
	<div style="margin-left: 15%; margin-right: 15%; margin-top: 5%;">
        <form class="form-horizontal" method="POST" id="callback-form"> 
            ...
            <div class="form-group">
				<div class="row">							
					<div class="col-xs-12">
						<input class="btn admSubmit" type="button" id="cb-submit" name="cb-submit" value='Schedule a Call' style="width:100%; margin-top:5%; margin-bottom: -2%;" onClick="return cbSubmit();">
					</div>
				</div>
			</div> 
