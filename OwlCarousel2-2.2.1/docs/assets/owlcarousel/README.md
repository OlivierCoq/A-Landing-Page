...
Stay tuned while the new owner sorts through some stuff. (Oh, hi, I'm [David](http://github.com/daviddeutsch)!)
...
- [npm](http://www.npmjs.com/package/owl.carousel): `npm install --save owl.carousel`
- [bower](http://bower.io/search/?q=owl.carousel): `bower install --save owl.carousel`

Or download the [latest release](http://github.com/OwlCarousel2/OwlCarousel2/releases).
...
Put the required stylesheet at the [top](http://developer.yahoo.com/performance/rules.html#css_top) of your markup:
...
Put the script at the [bottom](http://developer.yahoo.com/performance/rules.html#js_bottom) of your markup right after jQuery:
